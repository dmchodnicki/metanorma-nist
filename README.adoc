...
`:bib-additional-note:`:: Additional note (optional), used on coverpage of withdrawn and retired drafts.
...
* For retired drafts, the following attributes must be provided: `:circulated-date:`, `:abandoned-date:`, `:bib-additional-note:` (if applicable)
* For withdrawn drafts, the following attributes must be provided: `:circulated-date:`, `:obsoleted-date:`,
`:superseding-status:`, `:superseding-iteration:` (if applicable), `:superseding-title:` (if applicable),
`:superseding-circulated-date:`, `:superseding-doi:` (if applicable), `:superseding-url:`, `:bib-additional-note:` (if applicable)
* For withdrawn published documents, the following attributes must be provided: `:circulated-date:`, `:obsoleted-date:` (when
...
`:bib-additional-note:` (if applicable), `:obsoleted-by:` (giving the superseding document identifier). If the details
of the superseding document are not available to be retrieved from the CSRC website), the following attributes must
be provided: `:superseding-title:`, `:superseding-published-date:`
