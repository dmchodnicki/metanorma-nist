...
in case the document is historical, and needs to be generated with a previous authiruty statement.

`:obsoletes:`::
One or more NIST document that this NIST document standard supersedes. Comma delimited.
Format is document identifier, e.g. _SP 800-53A Rev. 1_

`:obsoleted-by:`::
One or more corresponding NIST document that this NIST document standard is superseded by. Comma delimited.
Format is document identifier, e.g. _SP 800-53A Rev. 1_
