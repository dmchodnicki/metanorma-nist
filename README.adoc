...
superseded or withdrawn. Used for withdrawn drafts.
...
`:superseding-doi:`::
The DOI of the draft document superseding this document. Used for withdrawn drafts.
`:superseding-url:`::
The URL of the draft document superseding this document. Used for withdrawn drafts.
