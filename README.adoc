...
* For retired drafts, the following attributes must be provided: `:circulated-date:`, `:abandoned-date:`
...
`:superseding-circulated-date:`, `:superseding-doi:` (if applicable), `:superseding-url:`
