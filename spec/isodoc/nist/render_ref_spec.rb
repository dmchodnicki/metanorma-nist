...
RSpec.describe IsoDoc::NIST do
  ...
  expect(xmlpp(
    ...
    gsub(%r{</body>.*}m, "</body>")
        ...
        it "formats a preformatted NIST SP reference with numeric cross-reference" do
    input = <<~"INPUT"
  <nist-standard xmlns="http://riboseinc.com/isoxml">
  <preface><foreword>
  <p id="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f">
    ...
    <h1 class="ForewordTitle"/>
        <p id="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f">
         <a href="#ISO712">[1]</a>
             ...
             <div>
               <h1 class="Section3">References</h1>
               <p id="ISO712" class="NormRef">[1] &#160; Homeland Security Presidential Directive 12, <i>Policy for a Common Identification Standard for Federal Employees and Contractors</i>, August 27, 2004. <a href="https://www.dhs.gov/homeland-security-presidential-directive-12">https://www.dhs.gov/homeland-security-presidential-directive-12</a> [accessed 5/16/18]</p>
             </div>
           </div>
         </body>
  OUTPUT
  ...
  expect(xmlpp(
    ...
    gsub(%r{</body>.*}m, "</body>")
                ...
                it "formats a preformatted NIST SP reference with alphanumeric cross-reference" do
    input = <<~"INPUT"
  <nist-standard xmlns="http://riboseinc.com/isoxml">
  <preface><foreword>
  <p id="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f">
    ...
    <h1 class="ForewordTitle"/>
        <p id="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f">
         <a href="#ISO712">[A]</a>
             ...
             <div>
               <h1 class="Section3">References</h1>
               <p id="ISO712" class="NormRef">[A] &#160; Homeland Security Presidential Directive 12, <i>Policy for a Common Identification Standard for Federal Employees and Contractors</i>, August 27, 2004. <a href="https://www.dhs.gov/homeland-security-presidential-directive-12">https://www.dhs.gov/homeland-security-presidential-directive-12</a> [accessed 5/16/18]</p>
             </div>
           </div>
         </body>
  OUTPUT
 ...
 <title>Canada Remembers the Korean War</title>
  ...
  #{HTML_HDR}
    ...
    <h1 class="ForewordTitle"/>
        <p id="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f">
         <a href="#ISO712">IEC 10.11/12.13</a>
         </p>
             </div>
             <br/>
             <div>
